/**
 *  Classu PsiTreeChangeListenerImpl som prevzal z diplomovej práce Mareka Bruchatého kde sa nachádza pod menom LivetestPsiTreeChangeListenerImpl.
 *
 * */
...
public class PsiTreeChangeListenerImpl implements PsiTreeChangeListener {

    private static final Logger log = Logger.getLogger(PsiTreeChangeListenerImpl.class.getName());

    PsiTreeChangeListenerImpl() {
        super();
